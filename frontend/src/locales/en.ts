...
export const EN_DICT: Record<string, string> = {
  ...
  "华鑫科技": "Brightline Components",
  "鼎盛材料": "Summit Materials",
  "芯片模组 A": "Chip Module A",
  "连接器 B": "Connector B",
  "PCB 板材": "PCB Panels",
  "¥75,000": "$7,500.00",
  "¥18,600": "$1,860.00",
  "¥42,300": "$4,230.00",
  "2024_Q3_采购订单.pdf": "2026_Q2_Purchase_Order.pdf",
  "供应商送货单_0915.jpg": "Delivery_Note_0915.jpg",
  "演示环境——所有示例数据均为合成数据，仅用于测试。": "Demo environment — all sample data is synthetic, for testing only.",
